package com.chia.multienty.core.fusion.sharding.listener;
    ...
    public void init() throws Exception {
        configService.addListener(dataId, groupId, new Listener() {
            ...
            public void receiveConfigInfo(String configInfo) {
                ...
                if(dynamicDs.getDataSources().containsKey(MultientyConstants.DS_SHARDING)) {
                    DataSource ds = dynamicDs.getDataSources().get(MultientyConstants.DS_SHARDING);

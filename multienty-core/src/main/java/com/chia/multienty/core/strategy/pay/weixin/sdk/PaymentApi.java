...
public class PaymentApi {
    ...
    * @return String
    */
   public static String pushOrder(Map<String, Object> params) {
     ...
     * @return String
     */
    public static String getSignKey(Map<String, Object> params) {
        String xml = PaymentKit.toXml(params);
        return HttpKit.post(getSignKeyUrl, xml);
    }

   private static Map<String, Object> request(String url, Map<String, Object> params, String partnerKey) {
    ...
    * @param partnerKey 签名密匙
    * </pre>
    * @return {String}
    */
   public static String getDeepLink(String appId, String prepayId, String partnerKey) {
    ...
    * @return 回调信息
    */
   public static Map<String, Object> queryByTransactionId(String appid, String mch_id, String paternerKey, String transaction_id) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("appid", appid);
    ...
    * @return 回调信息
    */
   public static Map<String, Object> queryByOutTradeNo(String appid, String mchId, String key, String outTradeNo) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("appid", appid);
       params.put("mch_id", mchId);
       params.put("out_trade_no", outTradeNo);
       return request(orderQueryUrl, params, key);
   }
    ...
    * @return 回调信息
    */
   public static Map<String, Object> closeOrder(String appid, String mchId, String key, String outTradeNo) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("appid", appid);
       params.put("mch_id", mchId);
       params.put("out_trade_no", outTradeNo);
       return request(closeOrderUrl, params, key);
   }
   ...
   private static Map<String, Object> baseRefundQuery(Map<String, Object> params, String appid, String mch_id, String partnerKey) {
       params.put("appid", appid);
       params.put("mch_id", mch_id);
       return request(refundQueryUrl, params, partnerKey);
   }
    ...
    * @return map
    */
   public static Map<String, Object> refundQueryByTransactionId(String appid, String mch_id, String paternerKey, String transaction_id) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("transaction_id", transaction_id);
    ...
    * @return map
    */
   public static Map<String, Object> refundQueryByOutTradeNo(String appid, String mch_id, String partnerKey, String out_trade_no) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("out_trade_no", out_trade_no);
       return baseRefundQuery(params, appid, mch_id, partnerKey);
   }
    ...
    * @return map
    */
   public static Map<String, Object> refundQueryByOutRefundNo(String appid, String mchId, String key, String outRefundNo) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("out_refund_no", outRefundNo);
       return baseRefundQuery(params, appid, mchId, key);
   }
    ...
    * @return map
    */
   public static Map<String, Object> refundQueryByRefundId(String appid, String mch_id, String paternerKey, String refund_id) {
       Map<String, Object> params = new HashMap<String, Object>();
    ...
    * @return String
    */
   public static String downloadBill(String appid, String mch_id, String partnerKey, String billDate, BillType billType) {
       Map<String, Object> params = new HashMap<String, Object>();
       params.put("appid", appid);
       params.put("mch_id", mch_id);
       params.put("nonce_str", System.currentTimeMillis() + "");

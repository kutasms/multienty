...
public enum HttpResultEnum {
    ...
    PATTERN_SERVICE_NOT_IMPLEMENT(606, "无法提供%s服务"),
    ...
    FILE_NOT_EXISTS(11005, "文件不存在,请重新选择"),
    ...
    DIRECTORY_MAKE_FAILURE(11018, "目录创建失败"),
    ...
    DUPLICATE_USERNAME(20023, "此账号已被注册，请更换其他帐号"),

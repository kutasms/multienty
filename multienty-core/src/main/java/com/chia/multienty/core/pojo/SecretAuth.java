...
@TableName("mt_secret_auth")
@ApiModel(value="SecretAuth对象", description="密钥授权")
public class SecretAuth extends KutaBaseEntity {
    ...
    @TableId(value = "sec_auth_id", type = IdType.INPUT)

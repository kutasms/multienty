...
import com.chia.multienty.core.sharding.registry.MTShardingAlgorithmProvidedBeanRegistry;
...
//    }
    ...
    public static Map<String, DataSource> getDataSourceMap() {
        ...
        if(ds.getDataSources().containsKey(MultiTenantConstants.DS_SHARDING)) {
            DataSource shardingDS = ds.getDataSources().get(MultiTenantConstants.DS_SHARDING);

...
public class WXPayUtil {
    ...
    * @return 含有sign字段的XML
    */
   public static String generateSignedXml(final Map<String, Object> data, String key, WXPayConstants.SignType signType) throws Exception {
    ...
    * @throws Exception
    */
   public static boolean isSignatureValid(Map<String, Object> data, String key, WXPayConstants.SignType signType) throws Exception {
       if (!data.containsKey(WXPayConstants.FIELD_SIGN) ) {
           return false;
       }
       String sign = data.get(WXPayConstants.FIELD_SIGN).toString();
    ...
    * @return 签名
    */
   public static String generateSignature(final Map<String, Object> data, String key, WXPayConstants.SignType signType) throws Exception {

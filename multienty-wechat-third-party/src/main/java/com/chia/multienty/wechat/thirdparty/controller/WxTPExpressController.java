...
public class WxTPExpressController {
    ...
    public Result<MsgPluginApplyResponse> applyMsgPlugin() {
        MsgPluginApplyResponse response = wxTPExpressService.applyMsgPlugin(MultientyContext.getMppAppId());
    ...
    public Result<QueryPluginApplyResponse> applyQueryPlugin() {
        QueryPluginApplyResponse response = wxTPExpressService.applyQueryPlugin(MultientyContext.getMppAppId());
        return new Result<>(response);
    }
    ...
    public Result<ReturnPluginApplyResponse> applyReturnPlugin() {
        ReturnPluginApplyResponse response = wxTPExpressService.applyReturnPlugin(MultientyContext.getMppAppId());
        return new Result<>(response);
    }
}

...
public class WxTPTemplateController {
    ...
    public Result<AddToTemplateResponse> addToTemplate(AddToTemplateParameter parameter) {
    ...
    public Result<TemplateDeleteResponse> deleteTemplate(TemplateDeleteParameter parameter) {
    ...
    @ApiOperation("获取模板列表响应数据")
    @PostMapping("getTemplateList")
    public Result<TemplateListGetResponse> getTemplateList(TemplateListGetParameter parameter) {

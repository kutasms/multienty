...
import com.chia.multienty.wechat.thirdparty.sdk.response.domain.ServerDomainModifyResponse;
 ...
 */
@Data
@WxApi(url = MerchantApis.Domain.MODIFY_SERVER_DOMAIN)
public class ServerDomainModifyRequest extends AuthorizerBaseRequest<ServerDomainModifyResponse> {
    /**
     * 操作类型
     */
